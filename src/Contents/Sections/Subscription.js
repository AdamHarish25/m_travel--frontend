...
const Subcription = () => {
    ...
    const className = {
        ...
        card: {
            container: "w-auto h-auto py-32 px-40 font-Poppins bg-SwirlBG bg-cover bg-no-repeat bg-center bg-[#DFD7F9]/30 flex flex-col justify-center items-center gap-20 rounded-tl-[100px]",
